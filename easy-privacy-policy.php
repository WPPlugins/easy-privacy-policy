...
<?php
		...
		function createContent() {
			...
			if( get_option('easy_privacy_acknowlegement') == true ) {
				$content = $content.'<span style="font-size:11px;">This policy was generated by Easy Privacy Policy Plugin <a title="bet365 poker" target="_blank" href="http://poker.toolazy.me.uk/bet365poker">bet365 poker</a> for WordPress.</span>';
			}
